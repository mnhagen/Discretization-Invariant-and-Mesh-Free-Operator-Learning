...
def generate_heat2d_autoreg(
    ...
    if filename is None:
        filename = f"heat2D_autoreg_N{N}_nu{nu}_samples{num_samples}_dt{dt}_store{store_every}.h5"
    ...
    def heat_solver(u0, nu, dt, N_t, store_every, ksq):
        """Integrate u_t = ν∇²u exactly in spectral space."""
    ...
    if make_animation:
        ...
        save_path_anim = os.path.join(anim_dir, f"heat2D_N{N}_nu{nu}.mp4")
